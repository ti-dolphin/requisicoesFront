...
import PatrimonyHome from "./Patrimony/pages/PatrimonyHome/PatrimonyHome";
import PatrimonyDetails from "./Patrimony/pages/PatrimonyDetails/PatrimonyDetails";
import PatrimonyChecklist from "./Patrimony/pages/PatrimonyChecklist/PatrimonyChecklist";
import CrmHome from "./crm/pages/CrmHome";
import ChecklistTasks from "./Patrimony/pages/ChecklistTasks/ChecklistTasks";
