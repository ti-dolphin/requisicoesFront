...
import { addedItemsType, style } from "./ItemsTable";
...
interface SearchAppBarProps {
  ...
  currentSelectedItem: addedItemsType | undefined;
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          > 
            ...
            <AddedItemsTable handleDelete={handleDelete} addedItems={addedItems} handleOpen={handleOpen}/>
            <Modal
